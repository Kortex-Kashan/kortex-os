...
| `ADR-0014` | Phase 7 — Production Hardening — Sentinel Engine | 2026-09-03 | `ACCEPTED` | Sentinel Engine (`kortex.engines.sentinel`) |
| `ADR-0015` | Phase 7 — Production Hardening — Monitoring Engine | 2026-09-04 | `ACCEPTED` | Monitoring Engine (`kortex.engines.monitoring`) |
| `ADR-0016` | Phase 7 — Production Hardening — Backup Engine | 2026-09-04 | `ACCEPTED` | Backup Engine (`kortex.engines.backup`) |
| `ADR-0017` | Phase 7 — Production Hardening — Recovery Engine | 2026-09-05 | `IMPLEMENTED` | Recovery Engine (`kortex.engines.recovery`) |
| `ADR-0019` | KORTEX Browser Runtime — WebView2 + Chromium Behind an IKortexBrowserRuntime Abstraction | 2026-09-25 | `ACCEPTED` | KORTEX Browser Runtime (`apps/desktop/src-tauri`, future `apps/desktop/src/features/browser`) |
