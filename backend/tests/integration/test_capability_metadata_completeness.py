...
_EXPECTED_RISK: dict[str, tuple[bool, bool]] = {
    ...
    "kortex.ai.conversation.list": (True, True),
    ...
    "kortex.desktop.click": (False, False),
    "kortex.desktop.launch": (False, False),
    "kortex.desktop.read_text": (True, False),
    "kortex.desktop.type": (False, False),
    ...
    "kortex.security.auth.refresh": (False, False),
