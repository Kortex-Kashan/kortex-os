...
class DesktopAgentGatewayStub(object):
...
class DesktopAgentGatewayServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_DesktopAgentGatewayServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'kortex.agent.v1.DesktopAgentGateway', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('kortex.agent.v1.DesktopAgentGateway', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class DesktopAgentGateway(object):
    """Missing associated documentation comment in .proto file."""
